...
class review_options_form extends moodleform {
    ...
    public function definition() {
        ...
        if(empty($this->_customdata['source'][0]) || empty($this->_customdata['dest'][0]) ) {
        ...
        $defaultroles = unserialize($this->_customdata['defaultroles']);        
        ...
        if(isset($this->_customdata['defaultroles']) && $this->_customdata['defaultroles'] != '' && !empty($rolesallowed)) {
        ...
        // $what = array(
        //     'value' => $this->_customdata['defaultwhat'],
        //     'source' => array(
        //             array(
        //                 'value' => COPY_EVERYTHING,
        //                 'text' => $this->get_copy_content_options(COPY_EVERYTHING),
        //                 ),
        //             array(
        //                 'value' => COPY_CONTENT_ONLY,
        //                 'text' => $this->get_copy_content_options(COPY_CONTENT_ONLY),
        //                 )
        //         )
        //     );
        ...
        // $this->page->requires->js_call_amd('local_culrollover/createeditabletable', 'initialise', $params);
